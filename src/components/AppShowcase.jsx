            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              >
                ...
                <div className="relative text-left">
                  <div className="text-xs font-medium text-gray-400">Download on the</div>
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-xs font-medium text-[#0F172A]/70">Get it on</div>
                  <div className="text-xl font-bold text-[#0F172A]">Google Play</div>
                </div>
              </a>
            </div>
          </motion.div>
