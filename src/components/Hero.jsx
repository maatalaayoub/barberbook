        ...
        <div className="flex min-h-[calc(100vh-88px)] items-center justify-center py-12">
          ...
          >
            ...
            <div className="mx-auto mb-10 max-w-2xl">
              <div className="flex items-center gap-2 rounded-[5px] bg-white p-1.5 shadow-xl shadow-black/20">
                <div className="flex flex-1 items-center gap-3 px-4 py-2.5">
                  <Search className="h-5 w-5 text-gray-400" />
                  <input 
                    type="text" 
                    placeholder="Search barber, salon, location, service..."
                    className="flex-1 bg-transparent text-[#0F172A] placeholder-gray-400 outline-none text-sm font-medium"
                  />
                </div>
                <div className="h-8 w-px bg-gray-200" />
                <button 
                  className="flex h-10 w-10 items-center justify-center rounded-[5px] text-gray-500 transition-all hover:bg-gray-100 hover:text-[#D4AF37]"
                  aria-label="Open map"
                >
                  <Map className="h-5 w-5" />
                </button>
                <button 
                  className="flex h-10 items-center gap-2 rounded-[5px] bg-gradient-to-r from-[#D4AF37] to-[#F4CF67] px-6 text-sm font-semibold text-[#0F172A] transition-all hover:shadow-lg hover:shadow-[#D4AF37]/30"
                >
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <a 
                href="/mobile-barber" 
                className="group flex items-center gap-2 rounded-[5px] bg-white/5 px-4 py-2.5 text-sm text-gray-300 transition-all hover:bg-[#D4AF37] hover:text-[#0F172A]"
              >
