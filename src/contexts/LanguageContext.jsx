...
const translations = {
  en: {
    // Hero
    heroTitle: 'Book Your Barbershop or Hair Salon',
    heroHighlight: 'Appointment',
    heroDescription: 'The smartest way to book barbershop appointments, hair salon visits, and reserve queue spots. Connect with professional barbers and hair stylists effortlessly. No more waiting in lines — enjoy your perfect look on your schedule.',
    ...
    howItWorksDesc: 'Simple, fast, and hassle-free. Your perfect barbershop or hair salon appointment is just a few taps away.',
    ...
    smartSchedulingDesc: 'Manage appointments and queues digitally. Reduce no-shows with automated reminders.',
    ...
    instantAppointmentBooking: 'Instant Appointment Booking',
    instantAppointmentBookingDesc: 'Book your preferred time slot instantly with just a few taps. No more phone calls or waiting.',
    smartQueueSystem: 'Smart Queue System',
    smartQueueSystemDesc: 'Join virtual queues and get real-time updates on your position. Arrive exactly when it\'s your turn.',
  ...
  fr: {
    // Hero
    heroTitle: 'Réservez Votre Barbier ou Salon de Coiffure',
    heroHighlight: 'Rendez-vous',
    heroDescription: 'La façon la plus intelligente de réserver des rendez-vous barbier, des visites au salon de coiffure et de réserver des places en file d\'attente. Connectez-vous avec des barbiers professionnels et des coiffeurs sans effort. Plus d\'attente — profitez de votre look parfait selon votre emploi du temps.',
    ...
    queueSystem: 'Système de file d\'attente',
    instantConfirmation: 'Confirmation instantanée',
    noWaiting: 'Sans attente',
    premiumService: 'Service premium',
    rateReview: 'Noter & évaluer',
    howItWorksDesc: 'Simple, rapide et sans tracas. Votre rendez-vous barbier ou salon de coiffure est à quelques clics.',
    ...
    smartSchedulingDesc: 'Gérez les rendez-vous et files d\'attente numériquement. Réduisez les absences avec des rappels automatiques.',
    ...
    instantAppointmentBooking: 'Réservation Instantanée',
    instantAppointmentBookingDesc: 'Réservez votre créneau préféré instantanément en quelques clics. Plus d\'appels téléphoniques ni d\'attente.',
    smartQueueSystem: 'Système de File Intelligent',
    smartQueueSystemDesc: 'Rejoignez les files virtuelles et recevez des mises à jour en temps réel. Arrivez exactement quand c\'est votre tour.',
  ...
  ar: {
    // Hero
    heroTitle: 'احجز موعدك في صالون الحلاقة أو تصفيف الشعر',
    heroHighlight: 'بسهولة',
    heroDescription: 'الطريقة الأذكى لحجز مواعيد صالون الحلاقة، زيارات صالون تصفيف الشعر، وحجز الدور. تواصل مع الحلاقين ومصففي الشعر المحترفين بسهولة. لا مزيد من الانتظار — استمتع بإطلالتك المثالية وفق جدولك.',
    ...
    step1Desc: 'اعثر على صالون الحلاقة أو صالون الشعر المثالي بالقرب منك. تصفح الملفات، اقرأ التقييمات، وقارن الخدمات.',
    ...
    howItWorksDesc: 'بسيط، سريع، وبدون متاعب. موعدك في صالون الحلاقة أو تصفيف الشعر على بعد نقرات قليلة.',
    ...
    smartSchedulingDesc: 'إدارة المواعيد والطوابير رقمياً. قلل من الغياب مع التذكيرات التلقائية.',
    ...
    instantAppointmentBooking: 'حجز موعد فوري',
    instantAppointmentBookingDesc: 'احجز موعدك المفضل فوراً بنقرات قليلة. لا مكالمات ولا انتظار.',
    smartQueueSystem: 'نظام طابور ذكي',
    smartQueueSystemDesc: 'انضم للطوابير الافتراضية واحصل على تحديثات فورية. احضر بالضبط عندما يحين دورك.',
