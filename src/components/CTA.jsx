...
export default function CTA() {
  ...
  const stats = [
    ...
    { value: '2K+', label: t('barbers') },
    { value: '100K+', label: t('bookingsMade') },
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="text-center lg:text-left">
              ...
              >
                ...
                <span className="text-sm font-medium text-[#D4AF37]">{t('availableNow')}</span>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-xs text-gray-500">{t('downloadOnThe')}</div>
                    <div className="text-lg font-semibold text-[#0F172A]">{t('appStore')}</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-xs text-gray-500">{t('getItOn')}</div>
                    <div className="text-lg font-semibold text-[#0F172A]">{t('googlePlay')}</div>
                  </div>
                </a>
              </motion.div>
            </div>
